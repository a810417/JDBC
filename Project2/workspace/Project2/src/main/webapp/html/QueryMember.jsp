								...
								<table>
									...
									<tr>
										...
										<td class="mb-3 mr-1"><input id="userPassword" name="userPassword" type="text"
												value="<%=mem.getUserPassword()%>" class="form-control">
										</td>
									</tr>
									<tr>
										<td>性別</td>
										<td class="mb-3 mr-1">
											<select name="userGender" id="userGender" class="form-select mt-3" required>
												<option disabled selected value="<%=mem.getUserGender()%>">
													<%=mem.getUserGender()%>
												</option>
									...
									<tr>
										...
										<td class="mb-3 mr-1"><input id="userHeight" name="userHeight" type="text"
												value="<%=mem.getUserHeight()%>" class="form-control"></td>
									</tr>
									<tr>
										<td>體重</td>
